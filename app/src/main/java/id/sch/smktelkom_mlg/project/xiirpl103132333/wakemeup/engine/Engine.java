...
import id.sch.smktelkom_mlg.project.xiirpl103132333.wakemeup.common.Memory;
import id.sch.smktelkom_mlg.project.xiirpl103132333.wakemeup.common.Music;
...
import id.sch.smktelkom_mlg.project.xiirpl103132333.wakemeup.events.EventObserverAdapter;
...
import id.sch.smktelkom_mlg.project.xiirpl103132333.wakemeup.model.BoardArrangment;
import id.sch.smktelkom_mlg.project.xiirpl103132333.wakemeup.model.BoardConfiguration;
...
public class Engine extends EventObserverAdapter {
	...
	public void onEvent(CustomStartEvent event) {
		...
		mPlayingGame = new Game();
		mPlayingGame.boardConfiguration = new BoardConfiguration(event.difficulty);
		mPlayingGame.theme = event.theme;
		mToFlip = mPlayingGame.boardConfiguration.numTiles;
